...
export const faqs =[
  {
    ...
    keywords: [
      "ubicación", "ubicacion", "dónde", "donde", "oficina", "dirección", "direccion", 
      "horario", "abierto", "cierran", "abren", "sede", "lugar", "capital", "caba"
    ],
    answer: "Nuestra sede principal se encuentra en **Av. Pte. R. Sáenz Peña 616, Piso 4, Oficina 403 (C1035), CABA**. Atendemos de **Lunes a Viernes de 09:00 a 18:00 hs**."
  },
  {
    // CONTACTO Y REDES
    keywords: [
      "contacto", "telefono", "teléfono", "llamar", "celular", "email", "correo", 
      "redes", "instagram", "facebook", "telegram", "uvenar"
    ],
    answer: "Puede contactarnos por WhatsApp al **(+54-9) 11-2711-1987** o al correo **portillokusyasociados@gmail.com**. Síganos en Instagram o Telegram como **@abogadoenargentina**."
  },
  {
    // HONORARIOS Y PAGOS
    keywords: [
      "precio", "costo", "honorarios", "pagar", "consulta", "valor", "cuanto sale", 
      "cuánto sale", "cobran", "medios de pago", "transferencia", "zelle", "paypal"
    ],
    answer: "Cada caso es único y requiere un análisis profesional detallado para presupuestarlo. Aceptamos múltiples métodos de pago internacionales y locales: **Efectivo, Transferencia, PayPal, Mercado Pago y Zelle**."
  },
  {
    // CIUDADANÍAS (General, Arg, Ita, Esp)
    keywords: [
      "ciudadanía", "ciudadania", "italiana", "española", "nacionalidad", "argentina", 
      "pasaporte", "dni", "naturalización", "naturalizacion", "carta de ciudadania"
    ],
  ...
  {
    // DERECHO MIGRATORIO & VISAS
    keywords: [
      "migración", "migraciones", "visa", "expulsión", "expulsion", "residencia", 
      "radicación", "radicacion", "precaria", "deportación", "eeuu", "americana", "mexico", "méxico"
    ],
  ...
  {
    // DEFENSA PENAL Y URGENCIAS
    keywords: [
      "penal", "preso", "comisaría", "comisaria", "cárcel", "carcel", "delito", 
      "defensa", "urgencia", "emergencia", "madrugada", "detenido", "allanamiento"
    ],
    answer: "Contamos con un equipo experto en **Defensa Penal**. Logramos resultados extraordinarios en casos complejos. Atendemos **urgencias las 24 horas**, asistiendo en comisarías e instancias críticas."
  },
  {
    // DERECHO DE FAMILIA
    keywords: [
      "divorcio", "familia", "alimentos", "cuota", "hijos", "visitas", "adopción", 
      "menores", "viaje", "autorización", "separación", "separacion", "curatela"
    ],
    answer: "Nuestro equipo de Familia maneja casos de **divorcios, cuota alimentaria, régimen de visitas, tutelas** y autorizaciones de viaje de menores al exterior, garantizando confidencialidad y contención."
  },
  {
    // DERECHO LABORAL Y ACCIDENTES
    keywords: [
      "laboral", "trabajo", "despido", "negro", "renuncia", "indemnización", "indemnizacion", 
      "accidente", "art", "delivery", "rappi", "pedidosya", "repartidor"
    ],
  ...
  {
    // DERECHO CIVIL, ALQUILERES Y DAÑOS
    keywords: [
      "alquiler", "inquilino", "propietario", "desalojo", "contrato", "daños", 
      "perjuicios", "veraz", "deuda", "estafa", "consumidor", "civil"
    ],
  ...
  {
    // COMERCIAL, EMPRESAS, MARCAS Y NOTARIAL
    keywords: [
      "empresa", "pyme", "marca", "registro", "sociedad", "comercial", "escribano", 
      "escribanía", "escribania", "firma", "habilitación", "local"
    ],
  ...
  {
    // TRÁMITES VENEZOLANOS Y EXTERIOR
    keywords: [
      "venezuela", "venezolano", "venezolanos", "poder", "poderes", "título", "titulo", 
      "convalidación", "convalidacion", "apostilla", "homologación", "extranjero"
    ],
